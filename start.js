...
var mcProxy = new KneeProx({
	username : '',  //Put what you use to login to minecraft here. Email/Username
	password : '',  //Put your password here. This is required because otherwise session stealers would be possible again.
	'online-mode': true,
	'max-players' : 1,
	serverPort: 25565,
	serverHost: 'mineplex.com', //Put the server you want to connect to's IP here.
	proxyPort: 25565,
	version: version,
	keepAlive : false,
